...
import { accountActionResultSchema } from '@/modules/identity-access/dto'
import {
  accountActionSchema,
  accountPathSchema,
} from '@/modules/identity-access/schemas'
import { changeAccountState } from '@/modules/identity-access/use-cases/accounts'
export async function POST(
  ...
  try {
    ...
    return NextResponse.json(accountActionResultSchema.parse(result), {
